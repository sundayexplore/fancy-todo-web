...
exports.request = supertest_1.default(app_1.default);
describe('User Model Tests', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, exports.request.post('/users/signup').send(signUpData)];
                case 1:
                    response = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, exports.request.post('/users/signin').send(signInData)];
                case 1:
                    response = _a.sent();
    ...
    test('Update Profile - Success', function () { return __awaiter(void 0, void 0, void 0, function () {
        var updateProfileData, token, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    updateProfileData = {
                    ...
                    return [4 /*yield*/, exports.request.put("/users/" + process.env.USER_ID).send(updateProfileData).set('token', token)];
                case 1:
                    response = _a.sent();
                    expect(response.body).toHaveProperty('user');
                    expect(response.body).toHaveProperty('message');
    ...
    test('Update Password - Success', function () { return __awaiter(void 0, void 0, void 0, function () {
        var updatePasswordData, token, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    updatePasswordData = {
                    ...
                    token = process.env.TOKEN;
                    return [4 /*yield*/, exports.request.patch("/users/" + process.env.USER_ID).send(updatePasswordData).set('token', token)];
                case 1:
                    response = _a.sent();
                    expect(response.body).toHaveProperty('user');
                    expect(response.body).toHaveProperty('message');
...
describe('Todo Model Test', function () {
    ...
    test('Create Todo - Success', function () { return __awaiter(void 0, void 0, void 0, function () {
        var createTodoData, token, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    createTodoData = {
                    ...
                    token = process.env.TOKEN;
                    return [4 /*yield*/, exports.request.post("/todos/" + process.env.USER_ID).send(createTodoData).set('token', token)];
                case 1:
                    response = _a.sent();
